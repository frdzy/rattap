...
define("SITE_NAME", "Rattap");  // Name of the site

// Path to the site with slash at the end  !!!!!!Important!!!!!!!!!!
/* Example: http://www.example.com/application/ */
define("SITE_PATH","http://seckin.rattap.com/");

define("ADMIN_NAME", "Administrator"); // Name of the administrator
define("ADMIN_EMAIL", "seckincansahin@gmail.com"); // Email of the administrator
...
define("SESSION_TIMEOUT", 0); // User timeout in seconds. 0 to disable timeout
...
define("COOKIE_EXPIRES", 60*60*24 * 600);  //600days. Cookie expiry time in seconds (default 1 day)

///////////////////////////////////////////////////////////////////////////////

/* User activation. If both are false, then admin has to activate account manually */
define("SEND_ACTIVATION_MAIL", FALSE); // Send activation email?
define("AUTO_ACTIVATE", TRUE); // Automatically activate user after registration?
